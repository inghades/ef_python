...
class ExternalFieldElectricOnRegularGridFromH5File( ExternalField ):
    ...
    def init_from_config( cls, field_conf, field_conf_name ):
        ...
        new_obj.x_volume_size = h5file["./Spatial_mesh"].attrs["x_volume_size"][0]
        new_obj.y_volume_size = h5file["./Spatial_mesh"].attrs["y_volume_size"][0]
        new_obj.z_volume_size = h5file["./Spatial_mesh"].attrs["z_volume_size"][0]
        new_obj.x_cell_size = h5file["./Spatial_mesh"].attrs["x_cell_size"][0]
        new_obj.y_cell_size = h5file["./Spatial_mesh"].attrs["y_cell_size"][0]
        new_obj.z_cell_size = h5file["./Spatial_mesh"].attrs["z_cell_size"][0]
        new_obj.x_n_nodes = h5file["./Spatial_mesh"].attrs["x_n_nodes"][0]
        new_obj.y_n_nodes = h5file["./Spatial_mesh"].attrs["y_n_nodes"][0]
        new_obj.z_n_nodes = h5file["./Spatial_mesh"].attrs["z_n_nodes"][0]
